...
export const Table: React.FC<Props> = ({ 
    ...
    const getCellClassName = (cell: TableCell, baseClassName: string): string => {
        if (cell && typeof cell === "object" && !isValidElement(cell) && "className" in cell && cell.className) {
    ...
    const generateRowKey = (row: Array<TableCell>, rowIndex: number): string => {
        ...
        if (firstCell && typeof firstCell === "object" && !isValidElement(firstCell) && "value" in firstCell) {
                        ...
                        return (
                            <tr key={uniqueRowKey} className={styles.tr}>
                                {row.map((cell, cellIndex) => {
                                    ...
                                    const cellClassName = getCellClassName(cell, cellIndex === 0 ? styles.th : styles.td);
