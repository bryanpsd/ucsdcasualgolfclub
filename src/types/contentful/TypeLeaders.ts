...
export function isTypeLeaders<Modifiers extends ChainModifiers, Locales extends LocaleCode>(
	entry: Entry<EntrySkeletonType, Modifiers, Locales>,
): entry is TypeLeaders<Modifiers, Locales> {
	return entry.sys.contentType.sys.id === "leaders";
}

export type TypeLeadersProps = TypeLeaders<"WITHOUT_UNRESOLVABLE_LINKS", "en-US">["fields"];
