...
export function isTypeSeasonRecap<Modifiers extends ChainModifiers, Locales extends LocaleCode>(
	entry: Entry<EntrySkeletonType, Modifiers, Locales>,
): entry is TypeSeasonRecap<Modifiers, Locales> {
	return entry.sys.contentType.sys.id === "seasonRecap";
}

export type TypeSeasonRecapProps = TypeSeasonRecap<"WITHOUT_UNRESOLVABLE_LINKS", "en-US">["fields"];
