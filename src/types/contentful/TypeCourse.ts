...
export function isTypeCourse<Modifiers extends ChainModifiers, Locales extends LocaleCode>(
  entry: Entry<EntrySkeletonType, Modifiers, Locales>
): entry is TypeCourse<Modifiers, Locales> {
  return entry.sys.contentType.sys.id === 'course'
}

export type TypeCourseProps = TypeCourse<'WITHOUT_UNRESOLVABLE_LINKS', 'en-US'>['fields']
